...
MAX_NUM_PROOFS: constant(uint256) = 1000

@external
@payable
def whitelistMint(proof: DynArray[bytes32, MAX_NUM_PROOFS]):
    """
...
@external
@payable
def allowlistMint(proof: DynArray[bytes32, MAX_NUM_PROOFS]):
    """
...
@internal
@pure
def verify(proof: DynArray[bytes32, MAX_NUM_PROOFS], root: bytes32, leaf: bytes32) -> bool:
